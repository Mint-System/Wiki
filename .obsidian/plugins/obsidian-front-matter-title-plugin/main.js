...
var CanvasManager = class extends AbstractManager {
  ...
  async setNodeTitle(node, title) {
    ...
    const inlineTitleEl =
      (_a = node.contentEl) == null ? void 0 : _a.querySelector('.inline-title')
...
var feature_config_default = (container) => {
  ...
  container
    ...
    .toFunction((item, resolver) => new ExplorerFileItemMutator(item, resolver))
  container
    ...
    new import_obsidian10.Setting(this.container)
      ...
      .addText((text) => {
        ...
        return text
          ...
          .setValue(
            (_a = this.item.get('common').get('main').value()) != null ? _a : ''
          )
...
var UtilBuilder = class {
  ...
  buildDebug(item, container) {
    new import_obsidian11.Setting(container)
      ...
      .addToggle((e) => e.setValue(item.value()).onChange((e2) => item.set(e2)))
  }
