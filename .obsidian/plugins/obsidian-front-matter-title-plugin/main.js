...
var ObjectHelper = class _ObjectHelper {
  static compare(old = {}, actual = {}) {
    const changed = {};
    const keys = [...Object.keys(old), ...Object.keys(actual)].filter(
      (e, i, s) => s.indexOf(e) === i,
    );
    for (const k of keys) {
      const first = old[k];
      ...
      if (type === "object" && !thereIsNull) {
        if (Array.isArray(first)) {
          ...
          const isChanged = hasDiff
            ? true
            : second.some((x) => !first.includes(x));
          if (isChanged) {
            changed[k] = true;
          }
        } else {
...
var MetadataReader = (function () {
  ...
  MetadataReader2.prototype.getConstructorMetadata = function (
    constructorFunc,
  ) {
...
function getTargets(metadataReader, constructorName, func, isBaseClass) {
  ...
  var propertyTargets = getClassPropsAsTargets(
    metadataReader,
    func,
    constructorName,
  );
  var targets = __spreadArray(
    __spreadArray([], constructorTargets, true),
    propertyTargets,
    true,
  );
  return targets;
...
var Request = (function () {
  function Request2(
    ...
    this.requestScope =
      parentRequest === null ? /* @__PURE__ */ new Map() : null;
  }
  Request2.prototype.addChildRequest = function (
    serviceIdentifier,
    bindings,
    target,
  ) {
    var child = new Request2(
      serviceIdentifier,
      this.parentContext,
      this,
      bindings,
  ...
  activeBindings.forEach(function (binding) {
    ...
    if (
      ...
      if (!context.container.options.skipBaseClassChecks) {
        var baseClassDependencyCount = getBaseClassDependencyCount(
          metadataReader,
          binding.implementationType,
        );
        if (dependencies.length < baseClassDependencyCount) {
          var error = ARGUMENTS_LENGTH_MISMATCH(
          ...
          y &&
            (t3 =
              op[0] & 2
                ? y["return"]
                : op[0]
                  ? y["throw"] || ((t3 = y["return"]) && t3.call(y), 0)
                  : y.next) &&
            !(t3 = t3.call(y, op[1])).done)
        )
          return t3;
...
var ensureFullyBound = function (binding) {
  ...
  if (boundValue === null) {
    var serviceIdentifierAsString = getServiceIdentifierAsString(
      binding.serviceIdentifier,
    );
  ...
  __assign =
    ...
    function (t3) {
      for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
        for (var p in s)
          if (Object.prototype.hasOwnProperty.call(s, p)) t3[p] = s[p];
      }
      return t3;
    };
...
function _createInstance(constr, childRequests, resolveRequest) {
  ...
  if (childRequests.length > 0) {
    ...
    var createInstanceWithInjectionsArg = __assign(__assign({}, resolved2), {
      constr,
    });
...
function createInstanceWithInjections(args) {
  var _a;
  var instance2 = new ((_a = args.constr).bind.apply(
    _a,
    __spreadArray2([void 0], args.constructorInjections, false),
  ))();
...
function _postConstruct(constr, instance2) {
  ...
  if (Reflect.hasMetadata(POST_CONSTRUCT, constr)) {
    ...
    try {
      return (_b = (_a = instance2)[data.value]) === null || _b === void 0
        ? void 0
        : _b.call(_a);
    } catch (e) {
...
function _onActivation(request, binding, resolved2) {
  ...
  var containersIterator = _getContainersIterator(
  ...
  do {
    ...
    var activationsIterator = _getContainerActivationsForService(
      container,
      serviceIdentifier,
    );
    if (isPromise(result)) {
...
var _activateContainerAsync = function (
  activationsIterator,
  context,
  resultPromise,
) {
...
var _getContainerActivationsForService = function (
  container,
  serviceIdentifier,
) {
...
var BindingWhenOnSyntax = (function () {
  ...
  BindingWhenOnSyntax2.prototype.whenAnyAncestorMatches = function (
    constraint,
  ) {
...
var BindingInWhenOnSyntax = (function () {
  ...
  BindingInWhenOnSyntax2.prototype.whenAnyAncestorTagged = function (
    tag,
    value,
  ) {
    return this._bindingWhenSyntax.whenAnyAncestorTagged(tag, value);
  ...
  BindingInWhenOnSyntax2.prototype.whenNoAncestorTagged = function (
    tag,
    value,
  ) {
    return this._bindingWhenSyntax.whenNoAncestorTagged(tag, value);
  };
  BindingInWhenOnSyntax2.prototype.whenAnyAncestorMatches = function (
    constraint,
  ) {
    return this._bindingWhenSyntax.whenAnyAncestorMatches(constraint);
  };
  BindingInWhenOnSyntax2.prototype.whenNoAncestorMatches = function (
    constraint,
  ) {
    return this._bindingWhenSyntax.whenNoAncestorMatches(constraint);
  };
...
var ContainerSnapshot = (function () {
  ...
  ContainerSnapshot2.of = function (
    bindings,
    middleware,
    activations,
    deactivations,
...
var ModuleActivationStore = (function () {
  ...
  ModuleActivationStore2.prototype.addDeactivation = function (
    moduleId,
    serviceIdentifier,
    onDeactivation,
  ) {
  ...
  ModuleActivationStore2.prototype.addActivation = function (
    moduleId,
    serviceIdentifier,
    onActivation,
  ) {
  ...
  ModuleActivationStore2.prototype._getModuleActivationHandlers = function (
    moduleId,
  ) {
...
var Container = (function () {
  ...
  Container3.merge = function (container1, container2) {
    ...
    var targetContainers = __spreadArray3(
  ...
  Container3.prototype.onActivation = function (
    serviceIdentifier,
    onActivation,
  ) {
    this._activations.add(serviceIdentifier, onActivation);
  };
  Container3.prototype.onDeactivation = function (
    serviceIdentifier,
    onDeactivation,
  ) {
  ...
  Container3.prototype.isBoundTagged = function (
    serviceIdentifier,
    key,
    value,
  ) {
  ...
  Container3.prototype.getTaggedAsync = function (
    serviceIdentifier,
    key,
    value,
  ) {
  ...
  Container3.prototype.getAllTaggedAsync = function (
    serviceIdentifier,
    key,
    value,
  ) {
  ...
  Container3.prototype._deactivate = function (binding, instance2) {
    ...
    try {
      if (this._deactivations.hasKey(binding.serviceIdentifier)) {
        var result = this._deactivateContainer(
          instance2,
        ...
        if (isPromise(result)) {
          return this._handleDeactivationError(
            result.then(function () {
              return _this._propagateContainerDeactivationThenBindingAndPreDestroyAsync(
                binding,
                instance2,
                constructor,
              );
      ...
      var propagateDeactivationResult =
  ...
  Container3.prototype._handleDeactivationError = function (
    asyncResult,
    constructor,
  ) {
    return __awaiter4(this, void 0, void 0, function () {
        ...
        switch (_a.label) {
          ...
          case 2:
            ...
            if (ex_1 instanceof Error) {
              throw new Error(
                ON_DEACTIVATION_ERROR(constructor.name, ex_1.message),
              );
            }
            return [3, 3];
          case 3:
  ...
  Container3.prototype._deactivateContainer = function (
    instance2,
    ...
    while (deactivation.value) {
      ...
      if (isPromise(result)) {
        return result.then(function () {
          return _this._deactivateContainerAsync(
            instance2,
            deactivationsIterator,
          );
        });
  ...
  Container3.prototype._deactivateContainerAsync = function (
    instance2,
    deactivationsIterator,
  ) {
    return __awaiter4(this, void 0, void 0, function () {
  ...
  Container3.prototype._getContainerModuleHelpersFactory = function () {
    ...
    var getOnActivationFunction = function (moduleId) {
      return function (serviceIdentifier, onActivation) {
        _this._moduleActivationStore.addActivation(
          moduleId,
          serviceIdentifier,
          onActivation,
        );
    ...
    var getOnDeactivationFunction = function (moduleId) {
      return function (serviceIdentifier, onDeactivation) {
        _this._moduleActivationStore.addDeactivation(
          moduleId,
          serviceIdentifier,
          onDeactivation,
        );
  ...
  Container3.prototype._get = function (getArgs) {
    var planAndResolveArgs = __assign2(__assign2({}, getArgs), {
  ...
  Container3.prototype._getNotAllArgs = function (
    serviceIdentifier,
    isMultiInject,
    key,
    value,
  ...
  Container3.prototype._propagateContainerDeactivationThenBindingAndPreDestroy =
    function (binding, instance2, constructor) {
      if (this.parent) {
  ...
  Container3.prototype._propagateContainerDeactivationThenBindingAndPreDestroyAsync =
    function (binding, instance2, constructor) {
      return __awaiter4(this, void 0, void 0, function () {
        return __generator4(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4,
                this._deactivate.bind(this.parent)(binding, instance2),
              ];
            case 1:
              _a.sent();
              return [3, 4];
  ...
  Container3.prototype._removeServiceFromDictionary = function (
    serviceIdentifier,
  ) {
    try {
  ...
  Container3.prototype._bindingDeactivationAndPreDestroy = function (
    binding,
    instance2,
    constructor,
  ) {
  ...
  Container3.prototype._bindingDeactivationAndPreDestroyAsync = function (
    binding,
    instance2,
    constructor,
  ) {
...
var GITHUB_DOCS =
  "https://github.com/snezhig/obsidian-front-matter-title/blob/master/docs/";
...
function getLastOfPath(object, path, Empty) {
  function cleanKey(key) {
    return key && key.indexOf("###") > -1
      ? key.replace(lastOfPathSeparatorRegExp, ".")
      : key;
  }
  ...
  handle(processors, value, key, options, translator) {
    processors.forEach((processor) => {
      if (this.processors[processor])
        value = this.processors[processor].process(
          value,
          key,
          options,
          translator,
  ...
  translate(keys, options, lastKey) {
    ...
    const keySeparator =
      options.keySeparator !== void 0
        ? options.keySeparator
        : this.options.keySeparator;
    const { key, namespaces } = this.extractFromKey(
      keys[keys.length - 1],
      options,
    );
    ...
    const joinArrays =
      options.joinArrays !== void 0
        ? options.joinArrays
        : this.options.joinArrays;
    const handleAsObjectInI18nFormat =
    ...
    if (
      ...
      const needsPluralHandling =
        options.count !== void 0 && typeof options.count !== "string";
      ...
      const resForMissing =
        missingKeyNoValueFallbackToKey && usedKey ? void 0 : res;
      const updateMissing =
        ...
        if (this.options.saveMissing) {
          if (this.options.saveMissingPlurals && needsPluralHandling) {
            lngs.forEach((language) => {
              const suffixes = this.pluralResolver.getSuffixes(
                language,
                options,
              );
              if (
        ...
        codes.forEach((code) => {
          ...
          if (this.i18nFormat && this.i18nFormat.addLookupKeys) {
            ...
            if (needsPluralHandling) {
              ...
              if (
                options.ordinal &&
                pluralSuffix.indexOf(ordinalPrefix) === 0
              ) {
                finalKeys.push(
                  key +
...
var LanguageUtil = class {
  ...
  toResolveHierarchy(code, fallbackCode) {
    ...
    if (
      typeof code === "string" &&
      (code.indexOf("-") > -1 || code.indexOf("_") > -1)
    ) {
  ...
  constructor(languageUtils) {
    ...
    if (
      (!this.options.compatibilityJSON ||
        intlVersions.includes(this.options.compatibilityJSON)) &&
    ...
    if (this.shouldUseIntlApi()) {
      try {
        return new Intl.PluralRules(
          getCleanedCode(code === "dev" ? "en" : code),
          {
...
var Interpolator = class {
  ...
  init() {
    ...
    this.useRawValueToEscape =
      useRawValueToEscape !== void 0 ? useRawValueToEscape : false;
  ...
  nest(str, fc) {
    ...
    function handleHasOptions(key, inheritedOptions) {
      ...
      if (
        (matchedSingleQuotes &&
          matchedSingleQuotes.length % 2 === 0 &&
          !matchedDoubleQuotes) ||
      ...
      if (
        clonedOptions.defaultValue &&
        clonedOptions.defaultValue.indexOf(this.prefix) > -1
      )
...
var Connector = class extends EventEmitter {
  ...
  saveMissing(languages, namespace, key, fallbackValue, isUpdate) {
    ...
    let clb =
      arguments.length > 6 && arguments[6] !== void 0 ? arguments[6] : () => {};
    if (
      this.services.utils &&
...
var I18n = class _I18n extends EventEmitter {
  ...
  init() {
    ...
    if (
      ...
      const codes = this.services.languageUtils.getFallbackCodes(
        this.options.fallbackLng,
      );
  ...
  loadResources(language) {
    let callback =
      arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : noop;
  ...
  use(module2) {
    ...
    if (
      module2.type === "logger" ||
      (module2.log && module2.warn && module2.error)
    ) {
  ...
  getFixedT(lng, ns, keyPrefix) {
    ...
    const fixedT = function (key, opts) {
      ...
      if (options.keyPrefix && Array.isArray(key)) {
        ...
        resultKey = options.keyPrefix
          ? `${options.keyPrefix}${keySeparator}${key}`
          : key;
      }
  ...
  loadLanguages(lngs, callback) {
    ...
    const newLngs = lngs.filter(
      (lng) =>
        preloaded.indexOf(lng) < 0 &&
        this.services.languageUtils.isSupportedCode(lng),
    );
    if (!newLngs.length) {
      if (callback) callback();
      return Promise.resolve();
  ...
  dir(lng) {
    ...
    const languageUtils =
      (this.services && this.services.languageUtils) || new LanguageUtil(get());
...
var zh = {
  ...
  util: "\u5DE5\u5177",
  coffee:
    "\u5982\u679C\u60A8\u559C\u6B22\u6B64\u63D2\u4EF6\u5E76\u5E0C\u671B\u5E2E\u52A9/\u652F\u6301\u4F5C\u8005\u6301\u7EED\u5F00\u53D1\uFF0C\u8BF7\u70B9\u51FB\u4EE5\u4E0B\u6309\u94AE:",
  debug_info: {
    title: "\u8C03\u8BD5\u4FE1\u606F",
...
var zh_tw = {
  ...
  util: "\u5DE5\u5177",
  coffee:
    "\u5982\u679C\u60A8\u559C\u6B61\u6B64\u63D2\u4EF6\u4E26\u5E0C\u671B\u5E6B\u52A9/\u652F\u6301\u4F5C\u8005\u6301\u7E8C\u958B\u767C\uFF0C\u8ACB\u9EDE\u64CA\u4EE5\u4E0B\u6309\u9215:",
  debug_info: {
    title: "\u8ABF\u8A66\u8CC7\u8A0A",
...
var SettingsTab = class {
  constructor(app, plugin, storage, dispatcher, factory) {
    ...
    dispatcher.dispatch(
      "settings.loaded",
      new Event({ settings: this.storage.collect() }),
    );
  }
  get containerEl() {
  ...
  buildDonation() {
    ...
    anchor.appendChild(
      new DOMParser().parseFromString(coffee, "text/xml").documentElement,
    );
...
var Factory = class {
  ...
  create(template) {
    const type = new RegExp(this.pattern).test(template)
      ? "composite"
      : "simple";
...
Factory = __decorateClass(
  [
    ...
    __decorateParam(
      1,
      inject(inversify_types_default["factory:template:resolver"]),
    ),
  ],
  Factory,
);
...
AbstractPlaceholder = __decorateClass([injectable()], AbstractPlaceholder);
...
MetaPlaceholder = __decorateClass(
  [
    ...
    __decorateParam(
      1,
      inject(inversify_types_default["factory:obsidian:meta"]),
    ),
  ],
  MetaPlaceholder,
);
...
var Creator = class {
  ...
  create(path, template) {
    ...
    for (const placeholder of this.pull(template).getPlaceholders()) {
      ...
      try {
        ...
        if (
          ...
          e instanceof TypeNotSupportedException
        ) {
    ...
    if (
      (_b = template == null ? void 0 : template.trim()) == null
        ? void 0
        : _b.length
    ) {
...
Creator = __decorateClass(
  [
    ...
    __decorateParam(
      0,
      inject(inversify_types_default["factory:creator:template"]),
    ),
...
Factory2 = __decorateClass(
  [
    ...
    __decorateParam(
      0,
      inject(inversify_types_default["factory:placeholder:resolver"]),
    ),
  ],
  Factory2,
);
...
var BracketsPlaceholder = class {
  ...
  setPlaceholder(placeholder) {
    ...
    const {
      ...
      new RegExp(`^{{((?<left>\\s*)(?<key>.*\\b)(?<right>\\s*))}}`),
    );
...
FilePlaceholder = __decorateClass(
  [
    ...
    __decorateParam(
      1,
      inject(inversify_types_default["factory:obsidian:file"]),
    ),
  ],
  FilePlaceholder,
);
...
var HeadingPlaceholder = class extends AbstractPlaceholder {
  ...
  makeValue(path) {
    var _a, _b, _c;
    return (_c =
      (_b = (_a = this.factory(path, "headings")) == null ? void 0 : _a[0]) ==
      null
        ? void 0
        : _b.heading) != null
      ? _c
...
var creator_config_default = new ContainerModule((bind) => {
  ...
  bind(inversify_types_default["creator:template"])
    .to(Simple)
    .whenTargetNamed("simple");
  bind(inversify_types_default["creator:template"])
    .to(Composite)
    .whenTargetNamed("composite");
  bind(inversify_types_default.placeholder)
    .to(MetaPlaceholder)
    .whenTargetNamed(AbstractPlaceholder.META);
  bind(inversify_types_default.placeholder)
    .to(FilePlaceholder)
    .whenTargetNamed(AbstractPlaceholder.FILE);
  bind(inversify_types_default.placeholder)
  ...
  bind(inversify_types_default.placeholder)
    .to(LogicPlaceholder)
    .whenTargetNamed(AbstractPlaceholder.LOGIC);
  bind(inversify_types_default["creator:creator"]).to(Creator);
  bind(
    inversify_types_default["factory:placeholder:resolver"],
  ).toAutoNamedFactory(inversify_types_default.placeholder);
  bind(inversify_types_default["getter:delimiter"]).toDynamicValue(
    (c) => () => c.container.get(inversify_types_default.delimiter),
  );
  bind(inversify_types_default["factory:placeholder"])
    .to(Factory2)
    .inSingletonScope();
});
...
AbstractFeature = __decorateClass([injectable()], AbstractFeature);
...
AbstractManager = __decorateClass([injectable()], AbstractManager);
...
var ExplorerManager = class extends AbstractManager {
  ...
  doEnable() {
    if (
      !this.facade.isInternalPluginEnabled("file-explorer" /* FileExplorer */)
    ) {
      this.logger.info(
        `internal plugin ${"file-explorer" /* FileExplorer */} is not enabled`,
      );
      return;
    }
  ...
  getExplorerFileItems() {
    var _a, _b;
    return (_b =
      (_a = this.getExplorerView()) == null ? void 0 : _a.fileItems) != null
      ? _b
      : {};
  }
...
ExplorerManager = __decorateClass(
  [
    ...
    __decorateParam(
      1,
      inject(inversify_types_default["feature:explorer:file_mutator:factory"]),
    ),
    __decorateParam(
      2,
      inject(inversify_types_default["factory:feature:explorer:sort"]),
    ),
    __decorateParam(3, inject(inversify_types_default["event:dispatcher"])),
...
var FeatureComposer = class {
  ...
  toggle(id3, state) {
    ...
    if (
      (!state && !feature) ||
      (state && (feature == null ? void 0 : feature.isEnabled()))
    ) {
      return;
    }
    if (!feature) {
...
var ExplorerSort = class {
  constructor(logger, facade, dispatcher, service, replacerFactory) {
    ...
    const trigger = (0, import_obsidian4.debounce)(
      this.onManagerUpdate.bind(this),
      1e3,
    );
    this.cb = (e) => {
      if (
        e.id === "explorer" /* Explorer */ &&
        (e.result === true || e.result === void 0)
      ) {
        trigger();
      }
    };
  ...
  initView() {
    ...
    this.view =
      (_b =
        (_a = this.facade.getViewsOfType("file-explorer" /* FE */)) == null
          ? void 0
          : _a[0]) != null
        ? _b
        : null;
  ...
  tryToReplaceOriginalSort() {
    ...
    if (this.replacer) {
      this.logger.log(
        `Replacer is exist already. State is ${this.replacer.isEnabled()}`,
      );
    ...
    this.replacer = this.replacerFactory(
      ...
      (feature, defaultArgs, vanilla) => {
        var _a;
        return (_a = feature.getSortedFolderItems(
          defaultArgs == null ? void 0 : defaultArgs[0],
        )) != null
          ? _a
          : vanilla.call(this);
      },
  ...
  getSortedFolderItems(folder) {
    ...
    children.sort((a, b) => {
      ...
      if (i && !r) {
        ...
        const at = i
          ? a.name
          : (_a = this.resolver.resolve(a.path)) != null
            ? _a
            : a.name;
        const bt = r
          ? b.name
          : (_b = this.resolver.resolve(b.path)) != null
            ? _b
            : b.name;
...
var SearchManager = class extends AbstractFeature {
  ...
  enable() {
    if (!this.facade.isInternalPluginEnabled("global-search" /* Search */)) {
      this.logger.info(
        `internal plugin ${"global-search" /* Search */} is not enabled`,
      );
      return;
    }
  ...
  isLeafActive() {
    var _a, _b;
    return (_b =
      (_a = this.facade.getLeavesOfType("search" /* S */)) == null
        ? void 0
        : _a[0]) == null
      ? void 0
      : _b.isVisible();
  ...
  getView() {
    var _a, _b;
    return (_b =
      (_a = this.facade.getViewsOfType("search" /* S */)) == null
        ? void 0
        : _a[0]) != null
      ? _b
      : null;
  ...
  getSearchDom() {
    ...
    if (!this.dom) {
      this.dom =
        (_b = (_a = this.getView()) == null ? void 0 : _a.dom) != null
          ? _b
          : null;
    }
    return this.dom;
...
SearchManager = __decorateClass(
  [
    ...
    __decorateParam(
      2,
      inject(inversify_types_default["service:search:dom:wrapper"]),
    ),
    __decorateParam(3, inject(inversify_types_default["feature:service"])),
  ...
  initReplacer() {
    ...
    this.replacer = FunctionReplacer.create(
      ...
      function (self2, [pinned], vanilla) {
        ...
        if (
          ((_a = this == null ? void 0 : this.view) == null
            ? void 0
            : _a.getViewType()) === "markdown" /* MD */
        ) {
...
TabManager = __decorateClass(
  [
    ...
    __decorateParam(
      2,
      inject(inversify_types_default["factory:obsidian:active:file"]),
    ),
  ],
  TabManager,
);
...
var AliasFeature = class extends AbstractFeature {
  ...
  setValidator(type) {
    ...
    this.logger.log(
      `Set validator [${type}]. Status: ${this.validator !== null}`,
    );
  }
  setStrategy(type) {
    this.strategy = this.strategyFactory(type);
    this.logger.log(
      `Set strategy [${type}]. Status: ${this.strategy !== null}`,
    );
  }
...
AliasFeature = __decorateClass(
  [
    ...
    __decorateParam(
      0,
      inject(inversify_types_default["factory:alias:modifier:strategy"]),
    ),
    __decorateParam(
      1,
      inject(inversify_types_default["factory:alias:modifier:validator"]),
    ),
    __decorateParam(2, inject(inversify_types_default.logger)),
    __decorateParam(2, named("alias:modifier")),
    __decorateParam(
      3,
      inject(inversify_types_default["factory:metadata:cache"]),
    ),
    __decorateParam(4, inject(inversify_types_default["event:dispatcher"])),
...
SuggestFeature = __decorateClass(
  [
    ...
    __decorateParam(
      0,
      inject(inversify_types_default["newable:obsidian:chooser"]),
    ),
...
var BookmarksManager = class extends AbstractFeature {
  ...
  tryEnable(subscribeOnActive = false) {
    var _a;
    const leaf =
      (_a = this.facade.getLeavesOfType("bookmarks" /* Bookmarks */)) == null
        ? void 0
        : _a[0];
    if (leaf.isVisible()) {
      if (
  ...
  initView() {
    ...
    const view =
      (_b =
        (_a = this.facade.getViewsOfType("bookmarks" /* Bookmarks */)) == null
          ? void 0
          : _a[0]) != null
        ? _b
        : null;
  ...
  onChanged(path = null) {
    ...
    for (const item of items) {
      ...
      if (
        ...
        item.type === "file" &&
        (item.title === "" ||
          (item == null ? void 0 : item.title) === void 0) &&
        (!path || item.path === path)
      ) {
  ...
  async process(div, path) {
    var _a;
    const title =
      (_a = this.resolver.resolve(path)) != null ? _a : div.getText();
...
var GraphManager = class extends AbstractManager {
  ...
  async doUpdate(path) {
    ...
    let result = false;
    for (const view of this.getViews()) {
      for (const node of (_b =
        (_a = view.renderer) == null ? void 0 : _a.nodes) != null
        ? _b
        : []) {
        if (node.id === path) {
          result = true;
  ...
  getFirstNode() {
    ...
    for (const view of this.getViews()) {
      const node =
        (_c = (
          (_b = (_a = view.renderer) == null ? void 0 : _a.nodes) != null
            ? _b
            : []
        ).first()) != null
          ? _c
  ...
  getViews() {
    return [
      ...this.facade.getViewsOfType("graph" /* G */),
      ...this.facade.getViewsOfType("localgraph" /* LG */),
    ];
  }
};
...
var MarkdownHeaderManager = class extends AbstractManager {
  ...
  doDisable() {
    this.dispatcher.removeListener(this.ref);
    this.facade
      .getViewsOfType("markdown" /* MD */)
      .forEach(this.revert.bind(this));
    this.enabled = false;
  }
  doEnable() {
    this.ref = this.dispatcher.addListener({
  ...
  setTitle(view, title) {
    this.logger.log(
      `Set title "${title != null ? title : " "}" for ${view.file.path}`,
    );
    ...
    if (title && el && el.innerText === title && !el.hidden) {
      return this.logger.log(
        `Set title "${title}" for ${view.file.path} is skipped`,
      );
    }
...
ValidatorRequired = __decorateClass([injectable()], ValidatorRequired);
...
ValidatorAuto = __decorateClass([injectable()], ValidatorAuto);
...
var InlineTitleManager = class extends AbstractManager {
      ...
      if (view.file && (!path || view.file.path === path)) {
        promises.push(
          this.resolve(view.file.path)
            .then((title) =>
              title
                ? ids.push(this.setTitle(view, title))
                : this.resetTitle(this.getTitleElId(view)),
            )
            .catch(console.error),
        );
      }
  ...
  setTitle(view, title) {
    this.logger.log(
      `Set inline title "${title != null ? title : " "}" for ${view.file.path}`,
    );
    const id3 = this.getTitleElId(view);
    const original = view.inlineTitleEl;
    const { created } = this.fakeTitleElementService.getOrCreate({
      original,
      title,
      id: id3,
      events: ["click"],
...
InlineTitleManager = __decorateClass(
  [
    ...
    __decorateParam(
      3,
      inject(inversify_types_default["service:fake_title_element"]),
    ),
  ],
  InlineTitleManager,
);
...
var CanvasManager = class extends AbstractManager {
  constructor(dispatcher, facade, logger, fakeTitleElementService) {
    ...
    this.updateByRequestFrame = (0, import_obsidian5.debounce)(
      () => {
        ...
        Array.from(this.queue.values()).forEach(
          (e) => this.innerUpdate(e) && this.queue.delete(e),
        );
      },
      1e3,
      true,
  ...
  async innerUpdate(path = null) {
    ...
    for (const view of canvasViews) {
      ...
      for (const node of canvas.nodes.values()) {
        if (
          !node.filePath ||
          (path && path !== node.filePath && path !== currentPath)
        ) {
          continue;
        }
        promises.push(
  ...
  restoreNodeTitle(node) {
    const ids = this.makeFakeElementIds(
  ...
  async setNodeTitle(node, title) {
    ...
    this.logger.log(
      `Set canvas title "${title}" for canvas "${view.file.path}" and node "${node.filePath}"`,
    );
...
FeatureHelper = __decorateClass([injectable()], FeatureHelper);
...
var BacklinkFeature = class extends AbstractFeature {
  ...
  enable() {
    this.enabled = this.facade.isInternalPluginEnabled(
      "backlink" /* Backlink */,
    );
  ...
  process() {
    ...
    for (const view of this.facade.getViewsOfType("markdown" /* MD */)) {
      const dom =
        (_a = view == null ? void 0 : view.backlinks) == null
          ? void 0
          : _a.backlinkDom;
      if (dom) {
  ...
  processBacklinkLayout() {
    ...
    const view =
      (_a = this.facade.getViewsOfType("backlink" /* BL */)[0]) != null
        ? _a
        : null;
    if (
      (_b = view == null ? void 0 : view.backlink) == null
        ? void 0
        : _b.backlinkDom
    ) {
      this.mutateService.wrapDom(
        view.backlink.backlinkDom,
        this.resolver,
        this.getId(),
      );
    }
...
var NoteLinkFeature = class extends AbstractFeature {
  ...
  async requestApprove(path) {
    ...
    const exec = this.config.approval
      ? await this.approve.request(path, changes)
      : true;
    if (exec) {
  ...
  async executeChanges(path, changes) {
    ...
    let content =
      file instanceof import_obsidian6.TFile
        ? await this.facade.getFileContent(file)
        : null;
    if (!content) {
      return;
    }
...
NoteLinkFeature = __decorateClass(
  [
    ...
    __decorateParam(
      3,
      inject(inversify_types_default["feature:notelink:approve"]),
    ),
  ...
  async request(path, changes) {
    return new Promise((r) => {
      ...
      contentEl.createEl("ul", null, (ul) =>
        changes.forEach((e) =>
          ul.createEl("li", { text: `${e.original} => ${e.replace}` }),
        ),
      );
      const btnContainer = contentEl.createDiv("modal-button-container");
      btnContainer
        .createEl("button", { cls: "mod-cta", text: t2("apply") })
        .addEventListener("click", () => {
          approved = true;
          modal.close();
        });
      btnContainer
        .createEl("button", { text: t2("cancel") })
...
NoteLinkApprove = __decorateClass(
  [
    ...
    __decorateParam(
      0,
      inject(inversify_types_default["factory:obsidian:modal"]),
    ),
  ],
  NoteLinkApprove,
);
...
var ExplorerFileItemMutator = class {
  ...
  updateTitle() {
    ...
    (title == null ? void 0 : title.length) > 0 &&
...
var WindowFrameFeature = class {
  constructor(facade, featureService, dispatcher) {
    ...
    this.ref = null;
    this.resolver = featureService.createResolver(this.getId());
    this.ref = dispatcher.addListener({
      name: "metadata:cache:changed",
      cb: this.onCacheChanged.bind(this),
    });
  }
  static getId() {
  ...
  onCacheChanged(e) {
    var _a;
    if (
      ((_a = this.facade.getActiveFile()) == null ? void 0 : _a.path) ===
      e.get().path
    ) {
      this.updateTitle();
    }
  ...
  updateTitle() {
    var _a;
    const e = this.facade.getMostRecentLeaf(
      this.facade.getActiveLeaf().getContainer(),
    );
    let text;
    if (
      e.view instanceof import_obsidian7.EditableFileView &&
      e.getViewState().state.file
    ) {
      text = this.resolver.resolve(e.getViewState().state.file);
    } else {
      text =
        (_a = e == null ? void 0 : e.getDisplayText().trim()) != null ? _a : "";
    }
...
var feature_config_default = (container) => {
  container
    .bind(inversify_types_default["feature:service"])
    .to(FeatureService)
    .inSingletonScope();
  container
    .bind(inversify_types_default["feature:composer"])
    .to(FeatureComposer)
    .inSingletonScope();
  container
    .bind(inversify_types_default["manager:composer"])
    .to(ManagerComposer)
    .inSingletonScope();
  container
    .bind(inversify_types_default["feature:helper"])
    .to(FeatureHelper)
    .inSingletonScope();
  container
    .bind(inversify_types_default["factory:feature"])
    .toAutoNamedFactory(inversify_types_default.feature)
    .onActivation((c, i) => (name) => {
      const feature = i(name);
      if (feature instanceof AbstractManager) {
        const service = c.container.get(
          inversify_types_default["feature:service"],
        );
  ...
  container
    .bind(inversify_types_default.feature)
    .to(AliasFeature)
    .whenTargetNamed(AliasFeature.getId());
  container
    .bind(inversify_types_default.feature)
  ...
  container
    .bind(inversify_types_default.feature)
    .to(ExplorerManager)
    .whenTargetNamed(ExplorerManager.getId());
  container
    .bind(inversify_types_default.feature)
    .to(SearchManager)
    .whenTargetNamed(SearchManager.getId());
  container
    .bind(inversify_types_default.feature)
    .to(BookmarksManager)
    .whenTargetNamed(BookmarksManager.getId());
  container
    .bind(inversify_types_default.feature)
    .to(TabManager)
    .whenTargetNamed(TabManager.getId());
  container
    .bind(inversify_types_default.feature)
    .to(SuggestFeature)
    .whenTargetNamed(SuggestFeature.getId());
  container
    .bind(inversify_types_default.feature)
    .to(GraphManager)
    .whenTargetNamed(GraphManager.getId());
  container
    .bind(inversify_types_default.feature)
  ...
  container
    .bind(inversify_types_default.feature)
    .to(BacklinkFeature)
    .whenTargetNamed(BacklinkFeature.getId());
  container
    .bind(inversify_types_default.feature)
    .to(NoteLinkFeature)
    .whenTargetNamed(NoteLinkFeature.getId());
  container
    .bind(inversify_types_default.feature)
  ...
  container
    .bind(inversify_types_default.feature)
    .to(CanvasManager)
    .whenTargetNamed(CanvasManager.getId());
  container
    .bind(inversify_types_default["factory:alias:modifier:strategy"])
    .toAutoNamedFactory(inversify_types_default["alias:modifier:strategy"]);
  container
    .bind(inversify_types_default["alias:modifier:strategy"])
    .to(EnsureStrategy)
    .whenTargetNamed("ensure" /* Ensure */);
  container
    .bind(inversify_types_default["alias:modifier:strategy"])
    .to(AdjustStrategy)
    .whenTargetNamed("adjust" /* Adjust */);
  container
    .bind(inversify_types_default["alias:modifier:strategy"])
    .to(ReplaceStrategy)
    .whenTargetNamed("replace" /* Replace */);
  container
    .bind(inversify_types_default["feature:alias:config"])
    .to(AliasConfig);
  container
    .bind(inversify_types_default["factory:alias:modifier:validator"])
    .toAutoNamedFactory(inversify_types_default["alias:modifier:validator"]);
  container
    .bind(inversify_types_default["alias:modifier:validator"])
    .to(ValidatorAuto)
    .whenTargetNamed("fa" /* FrontmatterAuto */);
  container
    .bind(inversify_types_default["alias:modifier:validator"])
    .to(ValidatorRequired)
    .whenTargetNamed("fr" /* FrontmatterRequired */);
  container
    .bind(inversify_types_default["feature:notelink:approve"])
    .to(NoteLinkApprove);
  container
    .bind(inversify_types_default["feature:config"])
    .toDynamicValue((c) => {
      const feature = c.currentRequest.target.getNamedTag().value;
      return c.container
        .get(inversify_types_default["settings:storage"])
        .get("features")
        .get(feature)
        .value();
    })
    .when(() => true);
  container
    .bind(inversify_types_default["feature:explorer:file_mutator:factory"])
    .toFunction(
      (item, resolver) => new ExplorerFileItemMutator(item, resolver),
    );
  container
    .bind(inversify_types_default["feature:explorer:sort"])
    .to(ExplorerSort);
  container
    .bind(inversify_types_default["factory:feature:explorer:sort"])
    .toFunction(() => {
      const enabled = container
        ...
        .value();
      return enabled
        ? container.get(inversify_types_default["feature:explorer:sort"])
        : null;
    });
};
...
var AbstractBuilder = class {
  ...
  dispatchChanges() {
    this.context
      ...
      .dispatch(
        ...
        new Event({ id: this.options.id, value: this.config }),
      );
  }
  buildEnable() {
    var _a;
    const fragment = ((_a = this.options.doc) == null ? void 0 : _a.link)
      ? createFragment((e) =>
          e.createEl("a", {
      ...
      : this.options.name;
    return new import_obsidian8.Setting(this.context.getContainer())
      .setName(fragment)
  ...
  buildTemplates(el) {
    ...
    for (const type of ["main", "fallback"]) {
      const tStorage = this.storage
        .get("features")
        .get(this.id)
        .get("templates")
        .get(type);
      const setting = new import_obsidian8.Setting(el)
        .setName(t2(`template.${type}`))
        .setDesc(this.getDesc(type, tStorage.value()))
        .addText((e) => {
          var _a;
          e.setValue((_a = tStorage.value()) != null ? _a : "")
  ...
  getDesc(type, value) {
    if (value) {
      ...
      return t2("template.used", {
        value: this.storage.get("templates").get("common").get(type).value(),
      });
    }
  }
};
...
DefaultBuilder = __decorateClass([injectable()], DefaultBuilder);
...
var AliasBuilder = class extends AbstractBuilder {
  ...
  buildValidatorDropdown(el) {
    ...
    this.validatorDropdown = new import_obsidian9.DropdownComponent(s.controlEl)
      .addOptions({
        ["fa" /* FrontmatterAuto */]: t2("feature.alias.validator.auto.name"),
        ["fr" /* FrontmatterRequired */]: t2(
          "feature.alias.validator.required.name",
        ),
      })
      .setValue(value ? value : "fr" /* FrontmatterRequired */)
      .onChange((v) => {
  ...
  buildStrategyDropdown(el) {
    ...
    const s = new import_obsidian9.Setting(el).setName(t2("strategy"));
    this.strategyDropdown = new import_obsidian9.DropdownComponent(s.controlEl)
      .addOptions({
      ...
      .setValue(value ? value : "ensure" /* Ensure */)
      .onChange((v) => {
...
AbstractBuilder2 = __decorateClass([injectable()], AbstractBuilder2);
...
var TemplatesBuilder = class extends AbstractBuilder2 {
  ...
  buildTemplate() {
    new import_obsidian10.Setting(this.container)
      .setName(this.createDocFragment(t2("template.common.main.name")))
      .setDesc(t2("template.common.main.desc"))
      .addText((text) => {
        var _a;
        return text
          .setPlaceholder(t2("template.placeholder"))
          .setValue(
            (_a = this.item.get("common").get("main").value()) != null
              ? _a
              : "",
          )
          .onChange(async (value) =>
            this.item.get("common").get("main").set(value),
          );
      });
  }
  buildFallbackTemplate() {
    new import_obsidian10.Setting(this.container)
      .setName(this.createDocFragment(t2("template.common.fallback.name")))
      .setDesc(t2("template.common.fallback.desc"))
      .addText((text) => {
        var _a;
        return text
          .setPlaceholder(t2("template.placeholder"))
          .setValue(
            (_a = this.item.get("common").get("fallback").value()) != null
              ? _a
              : "",
          )
          .onChange(async (value) =>
            this.item.get("common").get("fallback").set(value),
          );
      });
  }
};
...
var FeaturesBuilder = class extends AbstractBuilder2 {
  ...
  doBuild() {
    ...
    for (const item of data) {
      const builder =
        (_a = this.builderFactory(item.feature)) != null
          ? _a
          : this.builderFactory("default");
...
FeaturesBuilder = __decorateClass(
  [
    ...
    __decorateParam(
      0,
      inject(inversify_types_default["factory:settings:feature:builder"]),
    ),
    __decorateParam(1, inject(inversify_types_default["event:dispatcher"])),
...
var UtilBuilder = class {
  ...
  buildDebug(item, container) {
    new import_obsidian11.Setting(container)
      .setName(t2("debug_info.title"))
      .setDesc(t2("debug_info.desc"))
      .addToggle((e) =>
        e.setValue(item.value()).onChange((e2) => item.set(e2)),
      );
  }
  buildBoot(item, container) {
    new import_obsidian11.Setting(container)
      .setName(t2("boot_delay.title"))
      .setDesc(t2("boot_delay.desc"))
      .addText((e) =>
    ...
    new import_obsidian11.Setting(container)
      .setName(t2("boot_background.title"))
      .setDesc(t2("boot_background.desc"))
      .addToggle((e) =>
        e.setValue(item.get("background").value()).onChange((e2) => {
          item.get("background").set(e2);
        }),
      );
  }
};
UtilBuilder = __decorateClass([injectable()], UtilBuilder);
...
var RulesDelimiterBuilder = class extends AbstractBuilder2 {
  ...
  doBuild() {
    this.setting = new import_obsidian12.Setting(this.container)
      .setName(t2("rule.delimiter.name"))
      .setDesc(t2("rule.delimiter.desc"));
    this.buildDropdown();
    this.buildText();
  }
  buildDropdown() {
    const enabled = this.item.get("enabled");
    new import_obsidian12.DropdownComponent(this.setting.controlEl)
      .addOptions({
        N: t2("rule.delimiter.first"),
        Y: t2("rule.delimiter.join"),
      })
  ...
  buildText() {
    ...
    this.text = new import_obsidian12.TextComponent(this.setting.controlEl)
      .setValue(v.value())
  ...
  getPlaceholder() {
    return this.isEnabled()
      ? t2("rule.delimiter.placeholder.join")
      : t2("rule.delimiter.placeholder.first");
  }
  isEnabled() {
    return this.item.get("enabled").value();
  }
};
RulesDelimiterBuilder = __decorateClass([injectable()], RulesDelimiterBuilder);
...
var RulesPathsBuilder = class extends AbstractBuilder2 {
  ...
  doBuild() {
    this.settings = new import_obsidian13.Setting(this.container)
      .setName(t2("rule.path.name"))
      .addDropdown((e) =>
        e
          .addOptions({
            white: t2("rule.path.white.name"),
            black: t2("rule.path.black.name"),
          })
      ...
      .addTextArea((e) =>
        e
          ...
          .onChange((e2) =>
            this.item.get("values").set(e2.split("\n").filter((e3) => e3)),
          ),
      );
    this.updateDesc();
  }
...
RulesPathsBuilder = __decorateClass([injectable()], RulesPathsBuilder);
...
var ProcessorBuilder = class extends AbstractBuilder2 {
  ...
  doBuild() {
    ...
    this.setting = new import_obsidian14.Setting(this.container).setName(
      fragment,
    );
    this.buildDynamic();
  }
  ...
  buildDynamic() {
    ...
    this.setting.addDropdown((c) => {
      ...
      return c
        ...
        .setValue((_a = this.item.get("type").value()) != null ? _a : "")
        .onChange((v) => {
          var _a2, _b;
          ...
          this.item
            .get("args")
            .set([
              ...((_b = (_a2 = this.lastArgs) == null ? void 0 : _a2[value]) !=
              null
                ? _b
                : []),
            ]);
  ...
  buildReplace() {
    const items = [
      ...
      {
        name: t2("processor.replace.flags.name"),
        desc: t2("processor.replace.flags.desc"),
      },
      {
        name: t2("processor.replace.replacement.name"),
        desc: t2("processor.replace.replacement.desc"),
      },
    ];
      ...
      c.appendChild(
        createDiv(
          ...
          (e) => {
            var _a;
            e.appendChild(
              createDiv({ attr: { style: "margin-right: 10px" } }, (e2) =>
                e2.appendText(`${item.name}:`),
              ),
            );
            new import_obsidian14.TextComponent(e)
              .setValue(
                (_a = value == null ? void 0 : value[i]) != null ? _a : "",
              )
              .onChange((e2) => value.splice(i, 1, e2))
              .onChanged();
          },
        ),
      );
  ...
  buildFunction() {
    this.setting.addTextArea((e) =>
      e
        .setValue(this.item.get("args").value().join())
        .onChange((e2) => this.item.get("args").set([e2])),
    );
  }
};
...
var NoteLinkBuilder = class extends AbstractBuilder {
  ...
  buildStrategy(el) {
    new import_obsidian15.Setting(el)
      .setName(t2("feature.noteLink.strategy.name"))
      .setDesc(t2("feature.noteLink.strategy.desc"))
      .addDropdown((e) => {
        var _a;
        e.addOptions({
          ["all" /* All */]: t2("feature.noteLink.strategy.options.all"),
          ["onlyEmpty" /* OnlyEmpty */]: t2(
            "feature.noteLink.strategy.options.onlyEmpty",
          ),
        })
          .setValue(
            (_a = this.config.strategy) != null
              ? _a
              : "onlyEmpty" /* OnlyEmpty */,
          )
          .onChange((v) => {
  ...
  buildApproval(el) {
    new import_obsidian15.Setting(el)
      .setName(t2("feature.noteLink.approval.name"))
      .setDesc(t2("feature.noteLink.approval.desc"))
      .addDropdown((e) => {
        e.addOptions({
...
var ExplorerBuilder = class extends AbstractBuilder {
  ...
  buildSort(el) {
    new import_obsidian16.Setting(el)
      .setName(t2("feature.explorer.sort.name"))
      .setDesc(t2("feature.explorer.sort.desc"))
      .addToggle((e) => {
...
var settings_config_default = (c) => {
  c.bind(inversify_types_default["settings:feature:builder"])
    .to(DefaultBuilder)
    .whenTargetNamed("default");
  c.bind(inversify_types_default["settings:feature:builder"])
    .to(AliasBuilder)
    .whenTargetNamed("alias" /* Alias */);
  c.bind(inversify_types_default["settings:feature:builder"])
    .to(ExplorerBuilder)
    .whenTargetNamed("explorer" /* Explorer */);
  c.bind(inversify_types_default["settings:feature:builder"])
    .to(NoteLinkBuilder)
    .whenTargetNamed("noteLink" /* NoteLink */);
  c.bind(
    inversify_types_default["factory:settings:feature:builder"],
  ).toFunction((name) =>
    c.isBoundNamed(inversify_types_default["settings:feature:builder"], name)
      ? c.getNamed(inversify_types_default["settings:feature:builder"], name)
      : null,
  );
  c.bind(inversify_types_default["settings:builder"])
    .to(TemplatesBuilder)
    .whenTargetNamed("main");
  c.bind(inversify_types_default["settings:builder"])
    .to(FeaturesBuilder)
    .whenTargetNamed("main");
  c.bind(inversify_types_default["settings:builder"])
  ...
  c.bind(inversify_types_default["settings:builder"])
    ...
    .whenTargetNamed("main");
  c.bind(inversify_types_default["settings:builder"])
    .to(RulesDelimiterBuilder)
    .whenTargetNamed("rules");
  c.bind(inversify_types_default["settings:builder"])
    .to(RulesPathsBuilder)
    .whenTargetNamed("rules");
  ...
  constructor(args) {
    ...
    try {
      this.pattern = new RegExp(
        (_a = args == null ? void 0 : args[0]) != null ? _a : null,
        args == null ? void 0 : args[1],
      );
      this.replacement =
        (_b = args == null ? void 0 : args[2]) != null ? _b : null;
    } catch (e) {
      console.error(e);
    }
  }
...
var FunctionProcessor = class {
  constructor(args) {
    this.func = (args == null ? void 0 : args[0])
      ? new Function("title", args[0])
      : null;
  }
  process(value) {
    var _a, _b;
    return (_b = (_a = this.func) == null ? void 0 : _a.call(this, value)) !=
      null
      ? _b
      : value;
  }
...
var FunctionV2Processor = class {
  ...
  process(value) {
    ...
    return (_b = (_a = this.func) == null ? void 0 : _a.call(this, obj)) != null
      ? _b
      : obj.title;
  }
  getType() {
...
var processors_config_default = new ContainerModule((bind) => {
  bind(inversify_types_default.processor)
    .to(ReplaceProcessor)
    .whenTargetNamed("replace" /* Replace */);
  bind(inversify_types_default.processor)
    .to(FunctionProcessor)
    .whenTargetNamed("function" /* Function */);
  bind(inversify_types_default.processor)
    .to(FunctionV2Processor)
    .whenTargetNamed("functionV2" /* FunctionV2 */);
  bind(inversify_types_default["processor:args"]).toDynamicValue((c) =>
    c.container
      .get(inversify_types_default["settings:storage"])
      .get("processor")
      .get("args")
  ...
  bind(inversify_types_default["processor:factory"]).toAutoNamedFactory(
    inversify_types_default.processor,
  );
  bind(inversify_types_default["processor:argument.transformer"]).to(
    ProcessorArgumentTransformer,
  );
});
...
ResolverService = __decorateClass(
  [
    ...
    __decorateParam(
      0,
      inject(inversify_types_default["factory:resolver:resolver"]),
    ),
    __decorateParam(
      1,
      inject(inversify_types_default["factory:resolver:template"]),
    ),
    __decorateParam(2, inject(inversify_types_default.logger)),
...
var ResolverCachedProxy = class {
  constructor(resolver, cache, dispatcher) {
    ...
    dispatcher.addListener({
      name: "metadata:cache:changed",
      cb: (e) => this.handleDelete(e.get().path),
      sort: 0,
    });
    dispatcher.addListener({
      name: "file:rename",
...
var Resolver = class {
  ...
  get(path) {
    var _a;
    try {
      return (_a = this.dispatch(
        this.creator.create(path, this.template),
        path,
      )) != null
        ? _a
        : null;
...
var resolver_config_default = new ContainerModule((bind) => {
  bind(inversify_types_default["factory:resolver:template"]).toFactory(
    (c) => (value) => {
      var _a, _b;
      const storage = c.container.get(
        inversify_types_default["settings:storage"],
      );
      const [name, type] = value.split(":");
      const targetTemplates =
        (_a = storage.get("features").get(name)) == null
          ? void 0
          : _a.get("templates");
      const template =
        (_b = targetTemplates == null ? void 0 : targetTemplates.get(type)) ==
        null
          ? void 0
          : _b.value();
      return template
        ? template
        : storage.get("templates").get("common").get(type).value();
    },
  );
  bind(inversify_types_default.resolver)
    .to(ResolverCachedProxy)
    .whenTargetIsDefault();
  bind(inversify_types_default.resolver)
    .to(Resolver)
    .whenTargetNamed("original");
  bind(inversify_types_default["resolver:service"])
    .to(ResolverService)
    .inSingletonScope();
  bind(inversify_types_default["factory:resolver:resolver"]).toFactory(
    (c) => () => c.container.get(inversify_types_default.resolver),
  );
});
...
var api_adapter_config_default = new ContainerModule((bind) => {
  ...
  bind(inversify_types_default["factory:api"]).toFactory(
    (c) => () => c.container.get(inversify_types_default.api),
  );
...
ExtensionFilter = __decorateClass([injectable()], ExtensionFilter);
...
PathListFilter = __decorateClass(
  [
    ...
    __decorateParam(
      0,
      inject(inversify_types_default["component:black_white_list"]),
    ),
  ],
  PathListFilter,
);
...
BlackWhiteList = __decorateClass([injectable()], BlackWhiteList);
...
Cache = __decorateClass([injectable()], Cache);
...
Extractor = __decorateClass(
  [
    ...
    __decorateParam(
      0,
      multiInject(inversify_types_default["component:extractor:strategy"]),
    ),
  ],
  Extractor,
);
...
LiteralStrategy = __decorateClass([injectable()], LiteralStrategy);
...
NullStrategy = __decorateClass([injectable()], NullStrategy);
...
Debugger = __decorateClass([injectable()], Debugger);
...
LoggerComposer = __decorateClass([injectable()], LoggerComposer);
  ...
  getNoteLinks(path) {
    ...
    for (const link of links) {
      ...
      result.push({
        ...
        original: link.original,
        alias:
          (_a = link == null ? void 0 : link.displayText) != null ? _a : null,
      });
    }
    return result;
  }
...
var EventDispatcher = class {
  ...
  addListener({ name, cb, sort = null, once = false }) {
    ...
    sort =
      sort != null
        ? sort
        : ((_c = (_b = events[0]) == null ? void 0 : _b.sort) != null
            ? _c
            : 0) + 1;
  ...
  dispatch(name, e) {
    ...
    let shift = 0;
    for (const [i, item] of [
      ...((_b = (_a = this.events.get(name)) == null ? void 0 : _a.entries()) !=
      null
        ? _b
        : []),
    ]) {
...
var BlackWhiteListListener = class {
  ...
  handle({ changed, actual }) {
    ...
    if (
      (_b =
        (_a = changed == null ? void 0 : changed.rules) == null
          ? void 0
          : _a.paths) == null
        ? void 0
        : _b.values
    ...
    if (
      (_d =
        (_c = changed == null ? void 0 : changed.rules) == null
          ? void 0
          : _c.paths) == null
        ? void 0
        : _d.mode
...
var ProcessorListener = class {
  ...
  bind() {
    this.changedRef = this.dispatcher.addListener({
      name: "settings:changed",
      cb: (e) => this.make(e.get().actual),
    });
    this.dispatcher.addListener({
      name: "settings.loaded",
      cb: (e) => this.make(e.get().settings),
      once: true,
    });
  }
  unbind() {
...
ProcessorListener = __decorateClass(
  [
    ...
    __decorateParam(
      2,
      inject(inversify_types_default["processor:argument.transformer"]),
    ),
  ],
  ProcessorListener,
);
...
var FakeTitleElementService = class {
  ...
  getOrCreate({ original, title, id: id3, events = [] }) {
  ...
  extractId(e) {
    ...
    if (e instanceof HTMLElement) {
      return (_a = e.getAttribute(this.attr.fake)) != null
        ? _a
        : e.getAttribute(this.attr.original);
    }
    return null;
  }
  getOriginal(id3) {
    var _a, _b;
    return (_b =
      (_a = this.elements.get(id3)) == null ? void 0 : _a.original) != null
      ? _b
      : null;
  }
  has(id3) {
...
BooleanStrategy = __decorateClass([injectable()], BooleanStrategy);
...
var ResultDomWrapper = class {
  ...
  process() {
    ...
    const lookup =
      (_c =
        (_b = (_a = this.replacer) == null ? void 0 : _a.getTarget()) == null
          ? void 0
          : _b.resultDomLookup) != null
        ? _c
        : /* @__PURE__ */ new Map();
  ...
  processLookupItem(file, item) {
    var _a, _b;
    const restore = !((_a = this == null ? void 0 : this.replacer) == null
      ? void 0
      : _a.isEnabled());
    ...
    const text =
      (_b = restore ? null : this.resolver.resolve(file.path)) != null
        ? _b
        : file.basename;
...
var SearchDomWrapperService = class {
  ...
  selfClean() {
    ...
    for (const [tag, entities] of this.entities) {
      this.logger.log(
        `Tag ${tag} has ${entities.size} entities before self-clean`,
      );
      ...
      this.logger.log(
        `Tag ${tag} has ${entities.size} entities after self-clean`,
      );
    }
  }
};
...
Delayer = __decorateClass([injectable()], Delayer);

// config/inversify.config.ts
var Container2 = new Container();
Container2.bind(inversify_types_default["event:dispatcher"])
  .to(EventDispatcher)
  .inSingletonScope();
...
Container2.bind(inversify_types_default["component:black_white_list"])
  .to(BlackWhiteList)
  .inSingletonScope();
...
Container2.bind(inversify_types_default["component:extractor:strategy"]).to(
  LiteralStrategy,
);
Container2.bind(inversify_types_default["component:extractor:strategy"]).to(
  ArrayStrategy,
...
Container2.bind(inversify_types_default["logger:composer"])
  .to(LoggerComposer)
  .inSingletonScope();
Container2.bind(inversify_types_default.delayer).to(Delayer);
Container2.bind(inversify_types_default.logger)
  .toDynamicValue((context) => {
    return context.container
      .get(inversify_types_default["logger:composer"])
      .create(context.currentRequest.target.getNamedTag().value);
  })
  .when(() => true);
Container2.bind(inversify_types_default["service:note:link"])
  .to(FileNoteLinkService)
  .inSingletonScope();
Container2.bind(inversify_types_default["service:fake_title_element"]).to(
  FakeTitleElementService,
);
Container2.bind(inversify_types_default.listener)
  .to(BlackWhiteListListener)
  .whenTargetNamed("unnamed");
Container2.bind(inversify_types_default.listener)
  .to(ProcessorListener)
  .whenTargetNamed("unnamed");
...
Container2.bind(inversify_types_default["service:search:dom:wrapper"])
  .to(SearchDomWrapperService)
  .inSingletonScope();
...
var App2 = class {
  ...
  bind() {
    const dispatcher = this.container.get(
      inversify_types_default["event:dispatcher"],
    );
    dispatcher.addListener({
      name: "settings:changed",
  ...
  init(settings) {
    this.container
      .bind(inversify_types_default.delimiter)
      .toConstantValue(settings.rules.delimiter);
    this.container
      .get(inversify_types_default["logger:composer"])
      [settings.debug ? "enable" : "disable"]();
  }
  onSettingsChanged({ actual, changed }) {
    ...
    if (
      ...
      this.container
        .rebind(inversify_types_default.delimiter)
        .toConstantValue(actual.rules.delimiter);
    }
    if (changed.debug) {
      this.container
        .get(inversify_types_default["logger:composer"])
...
App2 = __decorateClass([injectable()], App2);
...
var ObsidianFacade = class {
  ...
  getFileLinksCache(path) {
    var _a, _b;
    return (_b = (_a = this.getFileCache(path)) == null ? void 0 : _a.links) !=
      null
      ? _b
      : [];
  }
  ...
  getActiveLeaf() {
    var _a, _b;
    return (_b = (_a = this.app.workspace) == null ? void 0 : _a.activeLeaf) !=
      null
      ? _b
      : null;
  }
  getActiveFile() {
    var _a, _b;
    return (_b =
      (_a = this.app.workspace) == null ? void 0 : _a.getActiveFile()) != null
      ? _b
      : null;
  }
  getWorkspace() {
...
var Migrator = class {
  ...
  migrate(version) {
    ...
    this.dispatcher.dispatch(
      "migrator:migrated",
      new Event({ from: currentVersion, to: version }),
    );
    return this.config;
  }
  v3_8_0() {
    ...
    if (Array.isArray((_a = this.config) == null ? void 0 : _a.templates)) {
      this.config.templates = {
        common: {
          main:
            (_d =
              (_c = (_b = this.config) == null ? void 0 : _b.templates) == null
                ? void 0
                : _c[0]) != null
              ? _d
              : PluginHelper.createDefaultSettings().templates.common.main,
          fallback:
            (_g =
              (_f = (_e = this.config) == null ? void 0 : _e.templates) == null
                ? void 0
                : _f[1]) != null
              ? _g
              : "",
...
var MetaTitlePlugin = class extends import_obsidian19.Plugin {
  ...
  async onload() {
    this.bindServices();
    this.dispatcher = this.container.get(
      inversify_types_default["event:dispatcher"],
    );
    this.logger = this.container.getNamed(
      inversify_types_default.logger,
      "main",
    );
    this.app.workspace.on("layout-change", () =>
      this.dispatcher.dispatch("layout:change", null),
    );
    this.app.workspace.on("active-leaf-change", () =>
      this.dispatcher.dispatch("active:leaf:change", null),
    );
    this.app.workspace.on("file-open", (file) =>
      this.dispatcher.dispatch("file:open", new Event(file)),
    );
    new App2();
    this.container
      .getAllNamed(inversify_types_default.listener, "unnamed")
      .map((e) => e.bind());
  ...
  async loadSettings() {
    ...
    let data = ObjectHelper.fillFrom(
    ...
    this.container
      .bind(inversify_types_default["settings:storage"])
      .toConstantValue(this.storage);
  ...
  async delay() {
    ...
    let promise = new Promise((r) =>
      setTimeout(() => {
        this.fc = inversify_config_default.get(
          inversify_types_default["feature:composer"],
        );
        this.mc = inversify_config_default.get(
          inversify_types_default["manager:composer"],
        );
        this.bind();
...
Loaded. Background: ${background}`),
  ...
  bindServices() {
    inversify_config_default
      .bind(inversify_types_default["factory:obsidian:file"])
      .toFactory(() => (path) => this.app.vault.getAbstractFileByPath(path));
    inversify_config_default
      .bind(inversify_types_default["factory:obsidian:meta"])
      .toFactory(() => (path, type) => {
        var _a;
        return (_a = this.app.metadataCache.getCache(path)) == null
          ? void 0
          : _a[type];
      });
    inversify_config_default
      .bind(inversify_types_default["facade:obsidian"])
      .toConstantValue(new ObsidianFacade(this.app));
    inversify_config_default
      .bind(inversify_types_default["factory:metadata:cache"])
      .toFunction(() => this.app.metadataCache);
    inversify_config_default
      .bind(inversify_types_default["obsidian:app"])
      .toConstantValue(this.app);
    inversify_config_default
      .bind(inversify_types_default["obsidian:plugin"])
      .toConstantValue(this);
    inversify_config_default
      .bind(inversify_types_default["newable:obsidian:chooser"])
      .toConstructor(
        //@ts-ignore
        Object.getPrototypeOf(
          this.app.workspace.editorSuggest.suggests[0].suggestions,
        ).constructor,
      );
    inversify_config_default
      .bind(inversify_types_default["factory:obsidian:active:file"])
      .toFunction(() => this.app.workspace.getActiveFile());
    inversify_config_default
      .bind(inversify_types_default["factory:obsidian:modal"])
      .toFunction(() => new import_obsidian19.Modal(this.app));
  }
  bind() {
    this.registerEvent(
      this.app.metadataCache.on("changed", (file, _, cache) =>
        this.dispatcher.dispatch(
          ...
          new Event({ path: file.path, cache }),
        ),
      ),
    );
    ...
    this.dispatcher.addListener({
      name: "settings:changed",
      cb: (e) => this.onSettingsChange(e.get().actual),
    });
  }
  reloadFeatures() {
    this.fc.disableAll();
