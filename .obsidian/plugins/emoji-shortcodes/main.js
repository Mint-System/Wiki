  ...
  static emojiReplace(shortcode, el) {
    ...
    if (el.hasChildNodes()) {
      ...
      el.textContent = el.textContent.replace(
        shortcode,
        (_a = emoji[shortcode]) !== null && _a !== void 0 ? _a : shortcode,
      );
    }
  }
}
EmojiMarkdownPostProcessor.emojiProcessor = (el) => {
  ...
  (_a = el.innerText.match(/[:][^\s:][^ \n:]*[:]/g)) === null || _a === void 0
    ? void 0
    : _a.forEach((e) => EmojiMarkdownPostProcessor.emojiReplace(e, el));
};
...
class EmojiPluginSettingTab extends obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle((cb) => {
        cb.setValue(this.plugin.settings.immediateReplace).onChange((value) =>
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle((cb) => {
        cb.setValue(this.plugin.settings.suggester).onChange((value) =>
          __awaiter(this, void 0, void 0, function* () {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle((cb) => {
        cb.setValue(this.plugin.settings.historyPriority).onChange((value) =>
          __awaiter(this, void 0, void 0, function* () {
    ...
    if (this.plugin.settings.historyPriority) {
      ...
      new obsidian.Setting(containerEl)
        ...
        .setClass("ES-sub-setting")
        .addButton((cb) => {
          cb.setButtonText("Clear").onClick(() =>
            __awaiter(this, void 0, void 0, function* () {
  ...
  onload() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      this.registerMarkdownPostProcessor(
        EmojiMarkdownPostProcessor.emojiProcessor,
      );
